...
<body class="d-flex">
    ...
    <div class="right-section flex-grow-1 d-flex flex-column">
        ...
        <div class="main flex-grow-1 d-flex flex-column p-4">
            ...
            <div class="content-main d-flex p-4">
                
                <!-- FAQ sections -->
                <div class="faq-container">
                	
                	<h2 class="faq-title mb-2">Contactez-nous</h2>
                    
                    <section class="faq-section">
                        <p class="faq-text mb-2">Nous aimerions connaître votre avis! Nous sommes intéressés à recevoir toutes les suggestions d'amélioration que vous jugez importantes.</p>
                    	<p class="faq-text mb-4">Envoyez-nous des idées que vous aimeriez trouver ici. Si vous trouvez une erreur, faites-le nous savoir!</p>
                    	<input class="form-control form-control-lg mb-4" type="text" placeholder="Votre nom" aria-label=".form-control-lg example">
                    	<input class="form-control form-control-lg mb-4" type="text" placeholder="Votre email" aria-label=".form-control-lg example">
                    	<textarea class="form-control mb-4" id="exampleFormControlTextarea1" placeholder="Votre message ..." rows="5" ></textarea>
                    	<button type="submit" class="btn btn-primary">Envoyer le message</button>
                    </section>
                </div>
                
                <!-- image of contact support -->
                <div class="faq-header text-center">
                  	<img src="<%=request.getContextPath()%>/resources/images/contact-support.png" alt="FAQ Image" class="faq-image mt-3">
              	</div> 
            </div>
        </div>    
    </div>
